...
import { useGLTF, useTexture, Loader, Environment, useFBX, useAnimations, OrthographicCamera, PerspectiveCamera } from "@react-three/drei";
import { SelectAvatarButton } from "../SelectAvatarButton/SelectAvatarButton";
...
interface AvatarProps {
    inputText: string;
    coninuousListening: boolean;
    setIsListening: (value: boolean) => void;
    avatar: string;
}

const Avatar = ({ inputText, coninuousListening, setIsListening, avatar }: AvatarProps) => {
    ...
    const setSelected = (e: { target: { id: React.SetStateAction<string> } }) => {
        console.log(e);
    };
    ...
    return (
        <div className={styles.Avatar}>
            ...
            >
                <PerspectiveCamera makeDefault zoom={2} position={[0.05, 1.65, 1]} />
